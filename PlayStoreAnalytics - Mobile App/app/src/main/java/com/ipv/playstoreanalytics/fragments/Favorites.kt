...
import com.ipv.playstoreanalytics.databinding.FragmentFavoritesBinding
...
class Favorites : Fragment(), MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //observe
        viewModel.favoritesAdapter.observe(viewLifecycleOwner){ favoritesAdapter ->
